...
public class BuscarProductoPrecioActivity extends AppCompatActivity {
    ...
    RadioButton rbnombreproducto, rbcodigoproducto,rbrazonproducto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rbrazonproducto = findViewById(R.id.rbrazon);
        ...
        rbnombreproducto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                etproducto.setInputType(1);  // envia el teclado de tipo alfanumerico
                Tipobusqueda = "Razon";
                etproducto.setText("");
            }
        });
